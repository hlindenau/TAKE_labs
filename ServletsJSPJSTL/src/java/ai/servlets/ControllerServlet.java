...
public class ControllerServlet extends HttpServlet {
 ...
 //myBean.setAuthorsFrame( Boolean.valueOf(request.getParameter("authorsFrame")) );
 myBean.setAuthorsFrame( request.getParameter( "authorsFrame" ) != null );
 ...
 java.util.Date releaseDate = calDate.getTime();
